module.exports = function(app, web3) {
    ...
    //get Erc20 balance 
    app.get('/node/address/:address/erc20balance/:contractAddr', (req, res) => {

        var addr = req.params.address;
        var contractAddr = req.params.contractAddr;
    ...
    app.get('/node/address/incresetoken', (req, res) => {
        var addr = req.params.address;

        var contractAddr = ('0xa7e62bde46bdfb7712a225586232a92c26ab617f');

        var tknAddress = (addr).substring(2);

        var contractData = ('0x70a08231000000000000000000000000' + tknAddress);
        contractSrv.addTokenToTotalSupply(contractAddr, contractData)
            .then(function(result) {
                console.log(result);
                var response = {
                    data: {
